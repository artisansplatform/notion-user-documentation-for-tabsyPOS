...
The **Data Export** feature allows you to **back up or migrate** your store data quickly and securely - without requiring cloud access or an active internet connection.
...
- **Sales:** Comprehensive transaction history for all completed sales.
- **Sales Items:** Item-level details for each transaction.
...
- **Return Items:**
- **Return Payments:**
- **Sales Report (aggregated Excel report):**
- **Returns Report (aggregated Excel report):**
