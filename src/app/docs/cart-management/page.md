...
After adding items to the cart, you can easily modify their details. Click the **edit icon** beside an item to update its **price**, or adjust the **quantity** using the **plus (+)** and **minus (–)** buttons, or by **entering the desired number directly in the quantity input field**. All changes are applied instantly and reflected in the **cart total**.
- **Delete Item from Cart**
To remove a product, click the **delete icon** next to the item in the cart. The system will instantly update the cart total after deletion.
- **Audio Mode**
...
- **Clear Cart**
Use the **Clear Cart** option to remove all items from the current cart at once. The system will ask for confirmation before clearing to prevent accidental loss of data.
- **Assign Customer to Cart or Add a New One**
