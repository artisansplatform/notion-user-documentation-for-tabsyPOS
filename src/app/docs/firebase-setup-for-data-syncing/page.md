...
## **Firebase Setup (For Data Syncing)**
...
![d3420c87-8e2c-4995-b6e5-d1b9f23acbaa.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z.png)

- Set the **Project Name**, e.g., _“TabsyPOS”_, and click **Continue**

![Create-project--Firebase-console-11-10-2025_10_33_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-1.png)

- **Disable Gemini in Firebase** and click **Continue**

![Create-project--Firebase-console-11-10-2025_10_36_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-2.png)

- **Disable Google Analytics** and click **Create Project**

    ![Create-project--Firebase-console-11-10-2025_10_37_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-3.png)

- Once your project is created, click **Continue** to proceed to the **Project Overview** page.

    ![Create-project--Firebase-console-11-10-2025_11_09_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-4.png)
...
![38fc47fb-f03b-4ca2-a93b-07c0950308ca.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-5.png)

- Select your **preferred database location** and click **Next**

    ![d9efb9a9-e6c9-4b69-9403-57065ee15710.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-6.png)

- Keep **Start in Locked Mode** selected (default) and click **Enable**

    ![af1c1b5b-ed9d-491d-ab8a-57f5a9181d6d.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-7.png)
...
- Replace both `false` values with `true`, as shown below, and click **Publish** to save.
    ...
    ![74f63fff-3701-48f1-8968-d4675bed3c2b.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-8.png)
...
- From the left sidebar, go to **Project Overview → Project Settings**
    ...
    ![05e5d4f2-99c1-477b-9bc7-eaed47f7ebe2.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-9.png)

- Click on the **Web icon (</>)** under **Your Apps**

    ![TabsyPOS--Project-settings--General--Firebase-console-11-10-2025_11_11_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-10.png)

- Add an **App Nickname** and click **Register App**

    ![TabsyPOS--Add-app--General--Firebase-console-11-10-2025_09_53_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-11.png)
...
- Click **Continue to Console** when done.
    ...
    ![TabsyPOS--Project-settings--General--Firebase-console-11-12-2025_10_20_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-12.png)
...
**Step 5: Connect Firebase to TabsyPOS**
    ...
    ![TabsyPOS-Smart-POS-System-11-10-2025_04_08_PM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-13.png)
...
- Any new data or updates in TabsyPOS will reflect here automatically after syncing.
    ...
    ![TabsyPOS--Realtime-Database--Data--Firebase-console-11-11-2025_10_17_AM.png](/images/docs/integrations/firebase-setup-for-data-syncing/2025-11-17T07:14:00.000Z-14.png)
